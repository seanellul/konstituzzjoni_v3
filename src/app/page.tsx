    ...
    <div className="overflow-x-hidden">
      ...
      <section className="min-h-[70vh] flex flex-col justify-center relative overflow-hidden">
        ...
        <div className="relative h-[150px] mb-4 overflow-hidden mx-auto max-w-4xl">
          <motion.div 
            className="absolute w-64 md:w-80 bg-white dark:bg-gray-800 rounded-lg shadow-md border border-gray-200 dark:border-gray-700 p-3 rotate-3 left-[20%] z-30"
            initial={{ y: 100, opacity: 0, rotate: 3 }}
            animate={{ y: 0, opacity: 0.9, rotate: 3 }}
            transition={{ delay: 0.8, duration: 0.7 }}
          >
            <div className="border-b border-gray-200 dark:border-gray-700 pb-2 mb-2">
              <h3 className="text-base font-serif font-bold text-primary-DEFAULT dark:text-primary-400">Chapter I</h3>
              <h4 className="text-sm text-gray-700 dark:text-gray-300">The Republic of Malta</h4>
            </div>
          ...
          <motion.div 
            className="absolute w-64 md:w-80 bg-white dark:bg-gray-800 rounded-lg shadow-md border border-gray-200 dark:border-gray-700 p-3 -rotate-2 right-[20%] z-20"
            initial={{ y: 100, opacity: 0, rotate: -2 }}
            animate={{ y: 0, opacity: 0.85, rotate: -2 }}
            transition={{ delay: 1, duration: 0.7 }}
          >
            <div className="border-b border-gray-200 dark:border-gray-700 pb-2 mb-2">
              <h3 className="text-base font-serif font-bold text-blue-600 dark:text-blue-400">Chapter IV</h3>
              <h4 className="text-sm text-gray-700 dark:text-gray-300">The Executive</h4>
            </div>
            <p className="text-xs text-gray-800 dark:text-gray-300">
        ...
        >
          <div className="flex flex-col items-center">
            ...
            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className="text-gray-500 dark:text-gray-400">
        ...
        <div className="container mx-auto px-6 relative z-10">
          ...
          >
            ...
            <div className="relative h-[400px]">
              ...
              <motion.div 
                className="absolute w-full max-w-md mx-auto bg-white dark:bg-gray-800 rounded-lg shadow-xl border border-gray-200 dark:border-gray-700 p-6 z-40 left-20"
                style={{ 
              ...
              >
                <div className="border-b border-gray-200 dark:border-gray-700 pb-4 mb-4">
                  <h3 className="text-xl font-serif font-bold text-primary-DEFAULT dark:text-primary-400">Chapter I</h3>
                  <h4 className="text-lg text-gray-700 dark:text-gray-300">The Republic of Malta</h4>
                </div>
                <div className="space-y-3">
                  <motion.p 
                    className="text-gray-800 dark:text-gray-300 py-2 border-b border-gray-100 dark:border-gray-700"
                ...
                <div className="mt-4 flex justify-end">
                  <Link href="/constitution/chapter/1" className="text-primary-DEFAULT dark:text-primary-400 hover:underline flex items-center gap-1">
              ...
              <motion.div 
                className="absolute w-full max-w-md mx-auto bg-white dark:bg-gray-800 rounded-lg shadow-md border border-gray-200 dark:border-gray-700 p-6 rotate-2 top-4 -left-8 z-30"
                style={{ 
              ...
              >
                <div className="border-b border-gray-200 dark:border-gray-700 pb-3 mb-3">
                  <h3 className="text-xl font-serif font-bold text-amber-600 dark:text-amber-400">Chapter III</h3>
                  <h4 className="text-lg text-gray-700 dark:text-gray-300">Fundamental Rights and Freedoms</h4>
                </div>
              ...
              <motion.div 
                className="absolute w-full max-w-md mx-auto bg-white dark:bg-gray-800 rounded-lg shadow-md border border-gray-200 dark:border-gray-700 p-6 rotate-3 bottom-5 -left-10 z-50"
                style={{ 
              ...
              <motion.div 
                className="absolute w-full max-w-md mx-auto bg-white dark:bg-gray-800 rounded-lg shadow-md border border-gray-200 dark:border-gray-700 p-6 rotate-5 top-16 -right-0 z-20"
                style={{ 
              ...
              >
                <div className="border-b border-gray-200 dark:border-gray-700 pb-3 mb-3">
                  <h3 className="text-xl font-serif font-bold text-orange-600 dark:text-orange-400">Chapter VI</h3>
                  <h4 className="text-lg text-gray-700 dark:text-gray-300">Parliament</h4>
                </div>
                <div className="space-y-2">
                  <p className="text-gray-800 dark:text-gray-300 py-1 border-b border-gray-100 dark:border-gray-700 text-sm">
        ...
        <div className="container mx-auto px-6">
          ...
          >
            {features.map((feature, index) => (
              <motion.div 
                key={index}
                className={`bg-white dark:bg-gray-800 rounded-lg shadow-sm border p-6 ${feature.color} hover:shadow-md transition-shadow`}
                variants={itemVariants}
              >
                <div className="mb-4">
                  {feature.icon}
